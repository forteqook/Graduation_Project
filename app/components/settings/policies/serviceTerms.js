...
import ScrollPageForm from '../../../utils/forms/scrollPageForm';
...
유한책임회사 바빌(이하 "회사"라고 합니다.)이 제공하는 바빌 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.  
...
1. 회사가 제공하는 서비스는 기본적으로 유료 또는 무료입니다. 단, 별도의 유료 서비스의 경우 해당 서비스에 명시된 요금을 지불하여야 사용 가능합니다.
...
2. 제1항의 경우 불특정 다수인을 상대로 통지를 함에 있어서는 웹사이트 등 기타 회사의 공지사항을 통하여 회원들에게 통지할 수 있습니다.
...
2) 회원이 개인위치정보를 수집한 당해 통신단말장치 외의 통신단말장치 또는 전자우편주소 등으로 통보할 것을 미리 요청한 경우 제 10 조 (서비스내용변경 통지 등) 회사가 서비스 내용을 변경하거나 종료하는 경우 서비스 내 “공지사항” 화면을 통해 공고할 수 있습니다. 
...
제1조 (시행일) 
이 약관은 2022년 01월 01일부터 시행합니다. 
제2조 (위치정보관리책임자) 2022년 01월 01일을 기준으로 다음과 같이 지정합니다. 
1. 소 속 : 유한책임회사 바빌
2. 성 명 : 박승규 
3. 연 락 처 : 010-6458-6973
`
                        }
                    </Text>
                )}
